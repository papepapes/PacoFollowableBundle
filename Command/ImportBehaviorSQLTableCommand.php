...
class ImportBehaviorSQLTableCommand extends ContainerAwareCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption('connection', null, InputOption::VALUE_OPTIONAL, 'The name of the connection you want to use.')
            ->setHelp(<<<EOT
...
<info>php app/console paco:followable:create-table --connection=default</info>

And tell this command to dump the SQL it runs on your connection:
